...
public class UserInputNotStatic {
     ...
     */
    public int getUserInputInt(String messageToDisplay) {
     ...
     */
    public String getUserInputString(String messageToDisplay) {
        System.out.println(messageToDisplay);
     ...
     */
    public double getUserInputDouble(String messageToDisplay) {
        System.out.println(messageToDisplay);
        try {
